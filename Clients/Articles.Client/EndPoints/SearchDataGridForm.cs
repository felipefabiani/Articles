...
public abstract class SearchDataGridFormBase<TRequest, TResponse> : FormBase<TRequest, TResponse>
    where TRequest : class, new()
    where TResponse : notnull, new()
{
    [Parameter] public DataGrid<TResponse> DataGrid { get; set; } = default!;
